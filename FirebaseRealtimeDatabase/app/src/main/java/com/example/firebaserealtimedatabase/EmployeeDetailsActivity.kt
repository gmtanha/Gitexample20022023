...
class EmployeeDetailsActivity : AppCompatActivity() {
    ...
    private fun openUpdateDialog(empId: String, empName: String) {
        ...
        val mDialogView = inflater.inflate(R.layout.udate_dialog,null)
        ...
        btnUpdateData.setOnClickListener {
            updateEmpData(empId,etEmpName.text.toString(),etEmpAge.text.toString(),etEmpSalary.text.toString())
            Toast.makeText(applicationContext,"EmployeeData Update",Toast.LENGTH_SHORT).show()
